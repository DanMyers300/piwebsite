...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      "@type": "ListItem",
      position: 3,
      name: "Signs of a Cheating Spouse",
      item: "https://watsonpiinvestigation.com/blog/signs-of-a-cheating-spouse",
    },
  ],
};
...
export const SignsOfACheatingSpouse = () => {
  return (
    <div>
      ...
      <PageHero image={LA} title="BLOG" imageAlt="Signs of a cheating spouse blog article" headingLevel="h2" />
          ...
          <article className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
            ...
            <div className="p-6 sm:p-8">
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                <Link to="/blog/search?tag=Private Investigator Austin TX" className="bg-gray-100 text-gray-600 text-sm px-3 py-1 rounded-full hover:bg-yellow-500 hover:text-gray-900 transition-colors">Private Investigator Austin TX</Link>
                <Link to="/blog/search?tag=Private Investigation Services Austin TX" className="bg-gray-100 text-gray-600 text-sm px-3 py-1 rounded-full hover:bg-yellow-500 hover:text-gray-900 transition-colors">Private Investigation Services Austin TX</Link>
                <Link to="/blog/search?tag=Private Investigators Austin TX" className="bg-gray-100 text-gray-600 text-sm px-3 py-1 rounded-full hover:bg-yellow-500 hover:text-gray-900 transition-colors">Private Investigators Austin TX</Link>
              </div>
